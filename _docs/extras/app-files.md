...
As part of [lono up](/reference/lono-cfn-deploy/), the files in the `app/files` folder can get zipped and uploaded to the lono managed s3 bucket. The files only get uploaded if they are referenced in your template with the `s3_url`.
